...
//  msg
    ...
    string msgExit3 = "Do you want to see again yours pokemon in the box? \nExit(E) or Continue(C): ";
    ...
    string msg6 = "I see that you would like to see the pokemon you have registered, so here's a list of their names: \n";
    string msg7 = "Select the Pokemon you would like to see!(Index): ";
...
//  start loop
    ...
    while (exit == "C" || exit == "c") {
        ...
        if (pokemonIndex >= 0 && pokemonIndex < poke.size()) {
            ...
            cout << "Weight(kg): " << poke[pokemonIndex].weight << endl;
